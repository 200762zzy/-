    ...
    , ui(new Ui::Widget)
{
    ...
    QTreeWidgetItem* liliangItem1= new QTreeWidgetItem(QStringList()<<"敏捷");
    QTreeWidgetItem* liliangItem2= new QTreeWidgetItem(QStringList()<<"智力");
    ui->treeWidget->addTopLevelItem(liliangItem);
    ui->treeWidget->addTopLevelItem(liliangItem1);
    ui->treeWidget->addTopLevelItem(liliangItem2);
    //添加对应的子节点
    ...
    liliangItem1->addChild(new QTreeWidgetItem(heroM1));
    liliangItem1->addChild(new QTreeWidgetItem(heroM2));
    liliangItem2->addChild(new QTreeWidgetItem(heroZ1));
    liliangItem2->addChild(new QTreeWidgetItem(heroZ2));
}
